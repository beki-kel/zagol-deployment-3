...
const SectionGridFilterCard: FC<SectionGridFilterCardProps> = ({
  ...
  return (
    <div
      className={`lg:pt-4 nc-SectionGridFilterCard px-20 flex flex-col items-center justify-center  ${className}`}
    >
      <Heading2 heading="Our Packages" />
      <p className="text-md font-thin mb-8 text-center px-36">
