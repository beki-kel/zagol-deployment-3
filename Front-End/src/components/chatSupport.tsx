    ...
    <>
      ...
      {(isChatOpen || mobileVisible) && (
        <div className="realtive">
          ...
          <div className=" fixed bottom-0 right-0 w-[100vw] lg:w-[50vw] h-[100vh] bg-gradient-to-br from-[#2995D3]/10 to-white dark:from-[#1e1e1e]/10 dark:to-[#2e2e2e] shadow-2xl z-[1200] flex flex-col backdrop-blur-2xl  transform transition-all duration-300 hover:shadow-[0_0_30px_-5px_rgba(41,149,211,0.3)]">
            <div className="flex justify-between items-center p-2 mb-2 border-b border-[#2995D3]/10 dark:border-[#444] relative">
              ...
              <h3 className="text-lg font-bold text-neutral-200 dark:text-neutral-100 z-10">
                Ask Zagol{" "}
                <p className="text-sm font-thin text-neutral-400 dark:text-neutral-6000">
                  {" "}
                  Get AI-powered help
                </p>
              </h3>
